            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8 items-start">
              <div>
                ...
                <div className="space-y-4">
                  ...
                  <p>
                    The print collection further comprises <b> 42 national and international journals, 24 magazines, and 8 newspapers. For advanced research, the library subscribes to premium e-resources such as IEEE, J-GATE, and DELNET. With CCTV surveillance and fire safety systems, the library ensures security while offering innovative, user-focused services</b> that foster teaching, learning, and research excellence.
                  </p>
                </div>
              </div>
              <div className="rounded-xl overflow-hidden shadow-lg">
